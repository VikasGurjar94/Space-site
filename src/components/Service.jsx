...
function Service() {
    ...
    return (
        <>
            <div  className=" bg-black  h-[110vh] md:h-[90vh] relative  w-full  ">
                ...
                <div id="service" className="absolute  h-[750px] flex justify-around items-center flex-col md:flex-row gap-4 md:justify-around md:items-baseline  top-15 w-full  z-99">
                    <div className="h-[40vh] hover:scale-105 transition-all ease-in-out duration-200 text-white flex flex-col justify-around items-center bg-blue w-[300px] rounded-2xl   bg-blue-900/60 backdrop-blur-sm ">
                    ...
                    <div className="h-[40vh] hover:scale-105 transition-all ease-in-out duration-200 text-white flex flex-col justify-around items-center bg-blue  w-[300px] rounded-2xl   bg-blue-900/60  ">
                    ...
                    </div><div className="h-[40vh] hover:scale-105 transition-all ease-in-out duration-200 text-white flex flex-col justify-around items-center bg-blue w-[300px] rounded-2xl   bg-blue-900/60  ">
